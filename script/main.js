...
require.config({
    ...
    paths: {
        ...
        "bootstrap" : "plugin/bootstrap-3.3.7/dist/js/bootstrap.min" ,
    ...
    shim : {
        //公共组件
        "jquery-ui" : [
            "css!plugin/jquery-ui-1.12.1/jquery-ui.min.css"
        ] ,
        "bootstrap" : [
            "css!plugin/bootstrap-3.3.7/dist/css/bootstrap.min.css"
        ],
        "font" : [
        ...
        //Siywell OS 样式文件
        "siywell" : [
            "css!style/module/siywell.css"
        ],
        "desktop" : [
            "css!style/module/desktop.css"
        ],
        "taskbar" : [
            "css!style/module/taskbar.css"
        ],
        "background" : [
            "css!style/module/background.css"
        ]
    }
});
